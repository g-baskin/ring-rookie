...
Exported function declared by the [[entities/calls-lib-api]] module at `frontend/src/lib/api/calls.ts:169`.
...
The source declaration begins at `frontend/src/lib/api/calls.ts:169`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/calls-lib-api]] (`frontend/src/lib/api/calls.ts:169`)
...
- `frontend/src/lib/api/calls.ts:169`
