...
Exported function declared by the [[entities/api-src-lib]] module at `frontend/src/lib/api.ts:32`.
...
The source declaration begins at `frontend/src/lib/api.ts:32`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/api-src-lib]] (`frontend/src/lib/api.ts:32`)
