...
Exported function declared by the [[entities/calls-lib-api]] module at `frontend/src/lib/api/calls.ts:153`.
...
The source declaration begins at `frontend/src/lib/api/calls.ts:153`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/calls-lib-api]] (`frontend/src/lib/api/calls.ts:153`)
...
- `frontend/src/lib/api/calls.ts:153`
