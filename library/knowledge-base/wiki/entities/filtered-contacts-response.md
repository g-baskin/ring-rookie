---
type: entity
title: "FilteredContactsResponse"
status: mature
created: "2026-08-13"
updated: "2026-08-13"
...
Exported data model declared by the [[entities/campaigns-lib-api]] module at `frontend/src/lib/api/campaigns.ts:319`.
...
The source declaration begins at `frontend/src/lib/api/campaigns.ts:319`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/campaigns-lib-api]] (`frontend/src/lib/api/campaigns.ts:319`)
...
- `frontend/src/lib/api/campaigns.ts:319`
