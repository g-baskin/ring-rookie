...
Exported data model declared by the [[entities/telephony-lib-api]] module at `frontend/src/lib/api/telephony.ts:47`.
...
The source declaration begins at `frontend/src/lib/api/telephony.ts:47`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/telephony-lib-api]] (`frontend/src/lib/api/telephony.ts:47`)
...
- `frontend/src/lib/api/telephony.ts:47`
