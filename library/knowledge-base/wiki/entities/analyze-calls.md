...
Exported function declared by the [[entities/calls-lib-api]] module at `frontend/src/lib/api/calls.ts:190`.

## Signature / Definition

```ts
export async function analyzeCalls(
  params: AnalyzeCallsParams,
): Promise<CallAnalysisResponse>;
```

## Behavior

The source declaration begins at `frontend/src/lib/api/calls.ts:190`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/calls-lib-api]] (`frontend/src/lib/api/calls.ts:190`)
...
- `frontend/src/lib/api/calls.ts:190`
