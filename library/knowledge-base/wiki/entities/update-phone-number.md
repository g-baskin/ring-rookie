...
Exported function declared by the [[entities/phone-numbers-lib-api]] module at `frontend/src/lib/api/phone-numbers.ts:133`.
...
The source declaration begins at `frontend/src/lib/api/phone-numbers.ts:133`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/phone-numbers-lib-api]] (`frontend/src/lib/api/phone-numbers.ts:133`)
...
- `frontend/src/lib/api/phone-numbers.ts:133`
