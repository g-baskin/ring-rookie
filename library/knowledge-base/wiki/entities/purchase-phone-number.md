...
Exported function declared by the [[entities/telephony-lib-api]] module at `frontend/src/lib/api/telephony.ts:156`.
...
The source declaration begins at `frontend/src/lib/api/telephony.ts:156`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/telephony-lib-api]] (`frontend/src/lib/api/telephony.ts:156`)
...
- `frontend/src/lib/api/telephony.ts:156`
