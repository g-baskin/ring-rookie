...
Exported function declared by the [[entities/languages-src-lib]] module at `frontend/src/lib/languages.ts:165`.
...
The source declaration begins at `frontend/src/lib/languages.ts:165`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/languages-src-lib]] (`frontend/src/lib/languages.ts:165`)
...
- `frontend/src/lib/languages.ts:165`
