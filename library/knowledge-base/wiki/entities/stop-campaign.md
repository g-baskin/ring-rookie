...
Exported function declared by the [[entities/campaigns-lib-api]] module at `frontend/src/lib/api/campaigns.ts:260`.
...
The source declaration begins at `frontend/src/lib/api/campaigns.ts:260`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/campaigns-lib-api]] (`frontend/src/lib/api/campaigns.ts:260`)
...
- `frontend/src/lib/api/campaigns.ts:260`
