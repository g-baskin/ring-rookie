...
Exported function declared by the [[entities/agents-lib-api]] module at `frontend/src/lib/api/agents.ts:236`.
...
The source declaration begins at `frontend/src/lib/api/agents.ts:236`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/agents-lib-api]] (`frontend/src/lib/api/agents.ts:236`)
...
- `frontend/src/lib/api/agents.ts:236`
