...
Exported data model declared by the [[entities/calls-lib-api]] module at `frontend/src/lib/api/calls.ts:86`.
...
The source declaration begins at `frontend/src/lib/api/calls.ts:86`; implementation behavior and side effects remain authoritative in that declaration.

## Connections

- **Defined by:** [[entities/calls-lib-api]] (`frontend/src/lib/api/calls.ts:86`)
...
- `frontend/src/lib/api/calls.ts:86`
