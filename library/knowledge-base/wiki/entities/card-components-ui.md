...
Source module at `frontend/src/components/ui/card.tsx:1` exporting 0 documented code entities.
...
- `react` (import declaration in `frontend/src/components/ui/card.tsx:1`)
- `@/lib/utils` (import declaration in `frontend/src/components/ui/card.tsx:3`)
